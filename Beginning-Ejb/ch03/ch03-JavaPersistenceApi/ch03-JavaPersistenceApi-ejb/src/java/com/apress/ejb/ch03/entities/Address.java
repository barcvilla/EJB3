...
@NamedQueries({
    ...
    , @NamedQuery(name = "Address.findByZipeCode", query = "SELECT a FROM Address a WHERE a.zipeCode = :zipeCode")})
public class Address implements Serializable {
    ...
    public Integer getZipeCode() {
        return zipeCode;
    }

    public void setZipeCode(Integer zipeCode) {
    ...
    public String toString() {
        return "com.apress.ejb.ch03.entities.Address[ id=" + id + " ]";
    }
